...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      icon: "💾",
      title: "Auto-Save",
      description: "Saves to your browser",
    },
    {
      icon: "🔄",
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 text-center"
                >
